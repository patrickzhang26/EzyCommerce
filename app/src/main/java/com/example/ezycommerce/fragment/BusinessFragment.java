...
public class BusinessFragment extends Fragment {
    ...
    public void getBusiness(){
        // Fetching business data from REST API
    ...
    public void getCategory(String cat){
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(BusinessFragment.this.getContext());
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof BusinessFragment.OnFragmentInteractionListener) {
            mListener = (BusinessFragment.OnFragmentInteractionListener) context;
        } else {
