...
public class CookFragment extends Fragment {
    ...
    public void getCook(){
        // Fetching cookbooks data from REST API
    ...
    public void getCategory(String cat){
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(CookFragment.this.getContext());
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof CookFragment.OnFragmentInteractionListener) {
            mListener = (CookFragment.OnFragmentInteractionListener) context;
        } else {
