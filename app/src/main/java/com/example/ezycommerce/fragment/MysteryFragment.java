...
public class MysteryFragment extends Fragment {
    ...
    public void getMystery(){
        // Fetching mystery data from REST API
    ...
    public void getCategory(String cat){
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(MysteryFragment.this.getContext());
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof MysteryFragment.OnFragmentInteractionListener) {
            mListener = (MysteryFragment.OnFragmentInteractionListener) context;
        } else {
