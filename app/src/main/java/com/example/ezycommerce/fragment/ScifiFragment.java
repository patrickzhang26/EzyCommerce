...
public class ScifiFragment extends Fragment {
    ...
    public static ScifiFragment newInstance(){
    ...
    public void getScifi(){
        // Fetching scifi data from REST API
    ...
    public void getCategory(String cat){
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(ScifiFragment.this.getContext());
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof ScifiFragment.OnFragmentInteractionListener) {
            mListener = (ScifiFragment.OnFragmentInteractionListener) context;
        } else {
